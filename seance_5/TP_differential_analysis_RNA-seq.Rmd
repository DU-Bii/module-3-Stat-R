...
## DESeq2 result table
parameters$workdir <- "~/DU-Bii/m3s5/"
dir.create(parameters$workdir, showWarnings = FALSE, recursive = TRUE)
write.table(
  x = deseq2.res.dds.2groups, 
  quote = FALSE, row.names = 1, col.names = NA,
  file = file.path(parameters$workdir, "DESeq2_all_genes.tsv"))

## Differentially expressed genes
write.table(
  x = deseq2.res.dds.2groups[deseq2.res.dds.2groups$positive, ], 
  quote = FALSE, row.names = 1, col.names = NA,
  file = file.path(parameters$workdir, "DESeq2_positive.tsv"))

## Differentially expressed genes
write.table(
  x = row.names(deseq2.res.dds.2groups[deseq2.res.dds.2groups$positive, ]), 
  quote = FALSE, row.names = FALSE, col.names = FALSE,
  file = file.path(parameters$workdir, "DESeq2_positive_geneIDs.txt"))
