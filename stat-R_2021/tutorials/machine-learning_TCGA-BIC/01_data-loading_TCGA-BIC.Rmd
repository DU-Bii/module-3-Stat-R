...
The TCGA samples have very long and structured IDs, whcih make them inconvenient to display on the type of graphs we would like to generate (boxplots, PC plots, heatmaps, ...). 
...
```{r box_plot_rand_samples, fig.height=12, fig.width=8, out.width="60%",  fig.cap="Box plot of a random selection of samples from the TCGA-BIC transcriptome dataset. "}
#### Box plot ####
sample_size <- 30
