...
### Example: Euclidian matrix, average linkage

```{r sample_tree_euclidian_average, fig.width=12, fig.height=5, out.width="100%", fig.cap="Sample tree of the expression matrix with Euclidian distance and average linkage. "}
#### Sample tree with Euclidian distance, average linkage ####
sample_tree_euclidian_average <- hclust(
  d = sample_dist_euclidian, method = "average")

plot(sample_tree_euclidian_average, 
...
```{r sample_tree_euclidian_average_colored, fig.width=12, fig.height=5, out.width="100%", fig.cap="Sample tree of the expression matrix with Euclidian distance and average linkage. "}

library(ClassDiscovery)
ClassDiscovery::plotColoredClusters(
  sample_tree_euclidian_average, 
...
Cut the tree to obtain 4 clusters of samples. 
