...
required_biocLib <- c("biomaRt", "edgeR", "DESeq2", "DESeq")
...
## Build a gene tree
gene_tree_pearson <- hclust(cor_pearson_gene)

## Plot the gene tree
plot(gene_tree_pearson, hang = -1, las = 1, 
     main = "Gene tree", labels = FALSE)
```
...
plot(gene_tree_pearson, hang = -1,
     main = "Gene tree with 7 clusters", labels = FALSE)
...
```{r biclustering}
pheatmap(t(fa_expr_selected), labels_col = "",
