...
required_cranLib <- c("knitr", "FactoMineR", "factoextra", "pheatmap")
...
if (!requireNamespace(lib, character.only = TRUE)) {
...
Suivez pas à pas la méthode proposée:
...
```{r acp_norm_filtered_genes, fig.width=8, fig.height=8, out.width="60%", fig.cap="PC plot of the samples from standardised values after gene selection. "}
