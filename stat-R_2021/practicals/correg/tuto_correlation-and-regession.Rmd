...
### THIS DOES NOT WORK ###
pfa <- read.delim(file = url, header = TRUE, sep = "\t")
...
### Exercise: writing a function to download and load a data file

### Solution: a function to automagically download and load a data file
