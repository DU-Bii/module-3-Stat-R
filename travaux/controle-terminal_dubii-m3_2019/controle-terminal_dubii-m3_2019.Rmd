...
Le rapport de travail consistera à remettre un document Rmd permettant aux évaluateurs de reproduire l'ensemble des résultats, et le rapport pdf produit au moyen de ce markdown. Ces deux documents sont à mettre dans une archive (nom.tgz) et à déposer sur [moodle](https://moodlesupd.script.univ-paris-diderot.fr/mod/assign/view.php?id=176370) avant le lundi 11 mars à 3h00, soit avant le début des stages.
Cette date est négociable, revenir vers nous (Jacques ou Anne) pour en discuter.
