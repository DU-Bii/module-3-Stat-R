...
| 3 | Analyse de données métagénomiques | |
| 4 | Analyse de données RNA-seq | |
| 5 | Comparaison de groupes et enrichissement | |
...
- [Synopsis](#synopsis)
    ...
    - [Séance 4. Analyse de données RNA-seq](#seance-4.-analyse-de-donnees-rna-seq)
    - [Séance 5. Comparaison de groupes et enrichissement](#seance-5.-comparaison-de-groupes-et-enrichissement)
...
### [Séance 4. Analyse de données RNA-seq](seance_4/README.md)
...
### [Séance 5. Comparaison de groupes et enrichissement](seance_5/README.md)
