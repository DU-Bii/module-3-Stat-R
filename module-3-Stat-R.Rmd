...
![](img/RforDataScience.png){:width="100px"} "R for Data Science", Hadley Wickham & Garrett Grolemund, O’Reilly [lien de téléchargement](https://r4ds.had.co.nz/index.html)

![](img/advancedR.png){:width="100px"} "Advanced R", Hadley Wickham, Chapman & Hall/CRC The R Series [lien de téléchargement](http://adv-r.had.co.nz/)
