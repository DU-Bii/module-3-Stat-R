...
packages <- c("knitr", "kableExtra", "FactoMineR", "clues", "RColorBrewer")
...
- Comment découvrir des "motifs" dans les données ?

![Iris de Fisher](img.path/iris_petal_sepal.png)
...
```{r cluster_viz}
plot(iris.scaled.acp, 
     col.ind = iris.scale.kmeans5$cluster,
     choix = "ind", 
     cex = 0.5)
