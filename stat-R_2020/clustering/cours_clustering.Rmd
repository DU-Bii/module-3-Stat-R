...
```{r fleur.iris.1, echo=FALSE, out.width="50%"}
...
```{r are_there_clusters, echo=FALSE, out.width="50%", fig.cap="données simulées : y a-t-il des groupes ?"}
...
```{r echo = FALSE, out.width = "80%", fig.height = 5, fig.width = 10}
par(mfrow = c(1,2))
...
```{r plot_4variables, out.width="50%"}
plot(mes.iris)
```
...
```{r normalisation_par_la_mediane, echo = FALSE, out.width="70%", fig.width=8, fig.height=6}
...
```{r normalisation_par_IQR, echo = FALSE, out.width="70%", fig.width=8, fig.height=6}
