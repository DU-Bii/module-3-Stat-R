...
Les données sont dans un répertoire partagé `/shared/projects/du_bii_2019/data/module3/seance4/BIC/`.

Nous allons définir une variable `data.folder` qui indiquera le chemin de ce dossier partagé, en fonction du serveur. 
