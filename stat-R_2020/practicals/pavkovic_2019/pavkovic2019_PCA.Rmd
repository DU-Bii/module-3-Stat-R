...
```{r eigen_values_plot, out.width="80%", fig.width=7, fig.height=5, fig.cap="Eigenvalues plot. "}
#### Plot eigen values ####
...
```{r pc_plots, fig.width=5, fig.height=5, out.width="50%", fig.cap="blabla"}
...
kable(cor(x),  caption = "Correlation between columns (samples) of the original expression matrix. ")

## Check that the permuted matrix is not correlated anymore
kable(cor(xShuffled), caption = "Correlation between columns of the shuffled expression matrix") ## Inter-sample correlations should be around 0 except in the diagonal
...
```{r shuffled_rows_PCA, out.width="50%", fig.width=5, fig.height=5, fig.cap="Negative control 2: PC plots of a matrix with row-wise shuffled values. "}
