---
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_file ='pavkovic2019_proteome_uuo.html') })
...
```{r memory_image}
#### Save memory image ####
outfiles["memory_image"] <- file.path(outdirs$results, paste0(parameters$filePrefix, "_memimage.Rdata"))
save.image(file = outfiles["memory_image"])
