...
* Le tableau contient non seulement les classes (colonne `cancer.type`) mais également les valeurs positive/negative pour trois gènes utilisés comme marqueurs pour diagnostiquer le type de cancer. 
