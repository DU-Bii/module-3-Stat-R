...
### Changer l'échelle de couleurs d'une carte de températures


```{r heatmap_markers, out.width="80%", fig.width=10, fig.height=10, fig.cap="Heat map of the expression matrix clustered by genes (rows) and samples (columns). The color code below the heatmap denote the immunological markers (ER1, PR1 Her2)"}
...
heatmap(as.matrix(BIC.expr),
        ...
        col = colorRampPalette(
          c("white","green","green4","violet","purple"))
        (100))
```
