...
Vous pouvez lire les données à l'aide de la fonction `read.table`, prenez patience c'est un gros fichiers. La ligne de commande est : `mes.expr <- read.table("data_R4/BIC_diff_exp.tsv", h=T)`.
